...
// In joe.scope(), "this" is the Student-prototype-object, "scope". 
// 2. What is "this" when joe.scopeArrow() is invoked?
// In joe.scopeArrow(), "this" is the global window. 
// 3. Explain why "this" is different when an arrow function is used.
// The reasing these are different is scope. The scope for the arrow functions is always the global window. The scope for a prototype object is always that object. 
